...
export default function Home() {
  ...
  // Reset state when parent iframe sends propedge:init (e.g. user switches back to Generative tab)
  useEffect(() => {
    function handleMsg(e: MessageEvent) {
      if (e.data?.type === "propedge:init") {
        setResult(null);
        setError("");
        setQuestion("");
        if (e.data.league) setLeague(e.data.league);
      }
    }
